# CMN-C1-155 — Agent Capability Registry & Request Routing Classification Agent
...
Manages a registry of deployed AI agent capabilities and routes incoming requests to
the most appropriate agent. Given a plain-text request, the agent classifies intent
against the capability registry and handles multi-agent orchestration routing
decisions, capability overlap resolution, and fallback escalation routing.
